...
class EnterPinsPortion extends StatefulWidget {
  final bool isDark;
  ...
  @override
  _EnterPinsPortionState createState() =>
      _EnterPinsPortionState();
}

class _EnterPinsPortionState extends State<EnterPinsPortion> {
