...
class CardTransactionDetails extends StatefulWidget {
  ...
  @override
  _CardTransactionDetailsState createState() =>
      _CardTransactionDetailsState();
}
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Text(
                                  widget.data.gateway_reference_details,
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Text(
                                  MyUtils.formatDate(widget.data.created_at),
                                  style: detailStyle,
                                  textAlign: TextAlign.end,
                                ),
                              )
