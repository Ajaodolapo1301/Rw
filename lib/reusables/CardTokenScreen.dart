...
class CardTokenScreen extends StatefulWidget {
  final bool isDark;
...
//
  ...
  @override
  _CardPinTokenScreenState createState() =>
      _CardPinTokenScreenState();
}

class _CardPinTokenScreenState extends State<CardTokenScreen> {
//  Dimens dimens;
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                    Text(
                      "Enter the token sent to your phone".toUpperCase(),
