...
import 'package:rex_money/flutterWave/widgets/home/flutterwave_payment.dart';
...
class Flutterwave {
  ...
  Flutterwave.forUIPayment({
    ...
    print("${this.currency} from flutterwave class");
...
//      this.acceptFrancophoneMobileMoney = false;
  ...
  String country;
  String _setCountry() {
    print("${this.currency} from set country");
...
print("${paymentManager.acceptCardPayment} country from init");
