...
class CardPaymentManager {
  ...
  Future<dynamic> payWithCard(final http.Client client,
    ...
    final Map<String, String> encryptedPayload = this._prepareRequest(chargeCardRequest);
    print("${chargeCardRequest.country} req body");
print("${this.isDebugMode}  is debug");
...
//        print("${responseBody.data.currency} kkkk");
